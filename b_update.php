<?php
    ...
    $sql="select * from `buyer` where buyer_ID=$user_id";
    ...
    $Telephone=$row['Telephone'];
        ...
        if(isset($_POST['sub'])){
            ...
            $sql="update `buyer` set name='$name',email='$email',address='$address',contact_no='$contact_no',nic='$nic',occupation='$occupation',user_name='$user_name',password='$password' where b_id=$b_id";
