<?php
include 'config.php'; //contact details save in message table
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //If the request method is not post,code is getting executed
    //It means php script was accessed directly without submitting the form
    //stop further exceution of PHP script
