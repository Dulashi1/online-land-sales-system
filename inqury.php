...
if(isset($_POST["submit"]))
{
  ...
  $sql= "INSERT INTO buyerinquiry(FullName, Email, ContactNo, Address, Distric , City , Price , LandDetails)
   VALUES('$FullName','$Email','$ContactNo','$Address','$Distric','$City','$Price','$LandDetails')";
   
   if($con->query($sql))
   {
    echo"your Data Insert Sucssefully 😊";
